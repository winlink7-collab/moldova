...
DROP DATABASE IF EXISTS moldova_brides;
CREATE DATABASE moldova_brides CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE moldova_brides;
...
-- Page blocks (dynamic content blocks added via inline editor)
