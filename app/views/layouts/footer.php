            ...
            <a href="<?= BASE_URL ?>/" class="flex items-center gap-3">
                <div class="size-12 shrink-0">
                    <svg viewBox="0 0 100 100" class="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                        <defs>
                            <linearGradient id="crownGoldFooter" x1="0%" y1="0%" x2="100%" y2="100%">
                                <stop offset="0%" style="stop-color:#ffd700"/>
                                <stop offset="50%" style="stop-color:#f2d00d"/>
                                <stop offset="100%" style="stop-color:#b89b06"/>
                            </linearGradient>
                        </defs>
                        <path d="M 15 55 L 20 80 L 80 80 L 85 55 L 70 65 L 60 45 L 50 60 L 40 45 L 30 65 Z" fill="url(#crownGoldFooter)" stroke="#8a7404" stroke-width="1"/>
                ...
                <div class="flex flex-col">
                    <h1 id="footerLogoTitle" class="text-2xl font-black leading-none tracking-tight uppercase" style="background:linear-gradient(135deg,#ffd700 0%,#f2d00d 50%,#b89b06 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;">Royal Date</h1>
                    <span id="footerLogoTagline" class="text-[10px] tracking-[0.25em] text-primary font-bold uppercase">Premium Dating Solutions</span>
                </div>
            </a>
