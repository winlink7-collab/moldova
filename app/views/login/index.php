<?php $pageTitle = 'כניסת חברי VIP - Moldova & Ukraine Luxury Brides'; $pageDescription = 'התחברו לחשבון ה-VIP שלכם באתר שידוכי היוקרה המוביל - Moldova & Ukraine Luxury Brides. גישה לפרופילים בלעדיים והתאמות אישיות.'; $currentPage = 'login'; ?>
<?php include BASE_PATH . '/app/views/layouts/header.php'; ?>

<!-- Login Page – Full-Screen Background with Overlay -->
<section class="relative min-h-[calc(100vh-5rem)] flex items-center justify-center py-12 px-4">
    ...
    <div class="relative z-10 w-full max-w-[500px] luxury-gradient p-8 md:p-12 rounded-xl gold-border shadow-2xl backdrop-blur-sm">
        ...
        <div class="flex items-center my-8">
            ...
            <span class="px-4 text-slate-500 text-sm">או באמצעות</span>
            <div class="flex-1 h-px bg-white/10"></div>
        </div>
        ...
        <div class="mt-8 text-center space-y-3">
            ...
            <p class="text-slate-400 text-sm">עדיין לא חברים? <a href="<?= BASE_URL ?>/register" class="text-primary font-bold hover:underline">הרשמה</a></p>
        </div>
...
document.getElementById('loginPageForm').addEventListener('submit', async function(e) {
    ...
    try {
        ...
        errEl.textContent = 'שגיאה בחיבור לשרת. נסו שוב מאוחר יותר.';
        errEl.classList.remove('hidden');
    }
});
