<?php
$pageTitle = t('about_title') . ' - Moldova & Ukraine Luxury Brides';
$pageDescription = t('about_hero_subtitle');
$currentPage = 'about';
...
<section class="relative py-24 md:py-32 px-6 text-center overflow-hidden">
    ...
    <div class="relative z-10 max-w-4xl mx-auto">
        ...
        <p id="aboutHeroSubtitle" class="text-slate-400 text-lg md:text-xl mb-10 max-w-2xl mx-auto"><?= t('about_hero_subtitle') ?></p>
    </div>
</section>
...
<section class="py-20 px-6 lg:px-20">
    <div class="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        <div class="order-2 md:order-1">
            <h3 id="aboutWhoTitle" class="text-primary text-3xl font-bold mb-6"><?= t('about_who_title') ?></h3>
            <div id="aboutWhoText" class="space-y-6 text-slate-300 text-lg leading-relaxed">
                <p><?= t('about_who_text_1') ?></p>
                <p><?= t('about_who_text_2') ?></p>
            </div>
        </div>
...
<section class="bg-surface py-16 px-6 lg:px-20">
    <div id="statsContainer" class="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8">
        <div class="text-center p-6 border-l border-primary/10">
            ...
            <div class="text-slate-400 text-sm uppercase tracking-wide" id="aboutStat1Label"><?= t('about_stat1_label') ?></div>
        </div>
        <div class="text-center p-6 border-l border-primary/10">
            <div class="text-primary text-4xl font-black mb-2" id="aboutStat2Num">500+</div>
            <div class="text-slate-400 text-sm uppercase tracking-wide" id="aboutStat2Label"><?= t('about_stat2_label') ?></div>
        </div>
        <div class="text-center p-6 border-l border-primary/10">
            <div class="text-primary text-4xl font-black mb-2" id="aboutStat3Num">100%</div>
            <div class="text-slate-400 text-sm uppercase tracking-wide" id="aboutStat3Label"><?= t('about_stat3_label') ?></div>
        </div>
        <div class="text-center p-6">
            <div class="text-primary text-4xl font-black mb-2" id="aboutStat4Num">VIP</div>
            <div class="text-slate-400 text-sm uppercase tracking-wide" id="aboutStat4Label"><?= t('about_stat4_label') ?></div>
        </div>
    </div>
</section>
...
<section class="py-20 px-6 lg:px-20">
    <div class="max-w-7xl mx-auto">
        <div class="text-center mb-16">
            <h3 id="aboutVisionTitle" class="text-white text-4xl font-bold mb-4"><?= t('about_vision_title') ?></h3>
        ...
        <div id="visionCards" class="grid md:grid-cols-3 gap-8">
            <div class="bg-card border border-white/10 p-8 rounded-xl hover:border-primary/40 transition-all group">
                ...
                <h4 id="aboutCard1Title" class="text-white text-xl font-bold mb-4"><?= t('about_card1_title') ?></h4>
                <p id="aboutCard1Text" class="text-slate-400"><?= t('about_card1_text') ?></p>
            </div>
            <div class="bg-card border border-white/10 p-8 rounded-xl hover:border-primary/40 transition-all group">
                ...
                <h4 id="aboutCard2Title" class="text-white text-xl font-bold mb-4"><?= t('about_card2_title') ?></h4>
                <p id="aboutCard2Text" class="text-slate-400"><?= t('about_card2_text') ?></p>
            </div>
            <div class="bg-card border border-white/10 p-8 rounded-xl hover:border-primary/40 transition-all group">
                ...
                <h4 id="aboutCard3Title" class="text-white text-xl font-bold mb-4"><?= t('about_card3_title') ?></h4>
                <p id="aboutCard3Text" class="text-slate-400"><?= t('about_card3_text') ?></p>
            </div>
        </div>
    </div>
</section>
                ...
                <div id="aboutWhyList">
                    <ul class="space-y-6">
                        <li class="flex items-start gap-4">
                            ...
                            <div>
                                <h5 id="aboutWhy1Title" class="text-white font-bold"><?= t('about_why1_title') ?></h5>
                                <p id="aboutWhy1Text" class="text-slate-400"><?= t('about_why1_text') ?></p>
                            </div>
                        </li>
                        <li class="flex items-start gap-4">
                            <span class="material-symbols-outlined text-primary mt-1">check_circle</span>
                            <div>
                                <h5 id="aboutWhy2Title" class="text-white font-bold"><?= t('about_why2_title') ?></h5>
                                <p id="aboutWhy2Text" class="text-slate-400"><?= t('about_why2_text') ?></p>
                            </div>
                        </li>
                        <li class="flex items-start gap-4">
                            <span class="material-symbols-outlined text-primary mt-1">check_circle</span>
                            <div>
                                <h5 id="aboutWhy3Title" class="text-white font-bold"><?= t('about_why3_title') ?></h5>
                                <p id="aboutWhy3Text" class="text-slate-400"><?= t('about_why3_text') ?></p>
                            </div>
                        </li>
                    </ul>
                </div>
...
<section class="py-20 px-6" style="background: linear-gradient(135deg, #f2d00d 0%, #b89b06 100%);">
    <div class="max-w-4xl mx-auto text-center">
        <h3 id="aboutCtaTitle" class="text-3xl md:text-5xl font-black text-background-dark mb-8"><?= t('about_cta_title') ?></h3>
        <p id="aboutCtaSubtitle" class="text-background-dark/80 text-lg md:text-xl mb-12 font-medium"><?= t('about_cta_subtitle') ?></p>
        <div class="flex flex-col sm:flex-row gap-6 justify-center">
            <a id="aboutCtaBtn1" href="<?= BASE_URL ?>/?login=1" class="bg-background-dark text-primary px-12 py-5 rounded-2xl font-bold text-xl hover:shadow-2xl transition-all inline-block"><?= t('about_cta_btn1') ?></a>
            <a id="aboutCtaBtn2" href="<?= BASE_URL ?>/process" class="border-2 border-background-dark text-background-dark px-12 py-5 rounded-2xl font-bold text-xl hover:bg-background-dark/10 transition-all inline-block"><?= t('about_cta_btn2') ?></a>
        </div>
    </div>
</section>
